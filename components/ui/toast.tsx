  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "success" && "border-green-600 bg-green-600 text-white",
        variant === "error" && "border-red-600 bg-red-600 text-white",
